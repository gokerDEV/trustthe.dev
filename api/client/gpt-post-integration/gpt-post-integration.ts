...
export const gptPostControllerCreateGptPost = async (createPostDto: CreatePostDto, options?: RequestInit): Promise<gptPostControllerCreateGptPostResponse> => {
  ...
  return customInstance<gptPostControllerCreateGptPostResponse>(getGptPostControllerCreateGptPostUrl(),
  {      
    ...options,
    method: 'POST',
...
export const getGptPostControllerSearchPostsUrl = (params: GptPostControllerSearchPostsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/gpt/posts/search?${stringifiedParams}` : `/gpt/posts/search`
}
...
export const gptPostControllerSearchPosts = async (params: GptPostControllerSearchPostsParams, options?: RequestInit): Promise<gptPostControllerSearchPostsResponse> => {
  ...
  return customInstance<gptPostControllerSearchPostsResponse>(getGptPostControllerSearchPostsUrl(params),
  {      
    ...options,
    method: 'GET'
...
export const gptPostControllerFindPostById = async (id: string, options?: RequestInit): Promise<gptPostControllerFindPostByIdResponse> => {
  ...
  return customInstance<gptPostControllerFindPostByIdResponse>(getGptPostControllerFindPostByIdUrl(id),
  {      
    ...options,
    method: 'GET'
...
export const gptPostControllerUpdateGptPost = async (id: string,
  ...
  return customInstance<gptPostControllerUpdateGptPostResponse>(getGptPostControllerUpdateGptPostUrl(id),
  {      
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const gptPostControllerUploadOpenAIFiles = async (id: string,
  ...
  return customInstance<gptPostControllerUploadOpenAIFilesResponse>(getGptPostControllerUploadOpenAIFilesUrl(id),
  {      
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const gptPostControllerUpdatePostFile = async (id: string,
  ...
  return customInstance<gptPostControllerUpdatePostFileResponse>(getGptPostControllerUpdatePostFileUrl(id,fileId),
  {      
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
