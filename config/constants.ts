...
const AUTHOR_URL = 'https://goker.art/goker';
const TWITTER_HANDLE = '@gokerART';
const TWITTER_CARD_TYPE = 'summary_large_image';
const ORGANIZATION_NAME = 'goker';
const ORGANIZATION_URL = 'https://goker.art';
...
const TTD = {
  ...
  commitAuthorLogin: process.env.VERCEL_GIT_COMMIT_AUTHOR_LOGIN || 'gokerDEV',
  commitMessage:
