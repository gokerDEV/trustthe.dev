 ...
 */
export const discoveryControllerGetAuthorizationServerMetadataResponse =
  zod.object({
    ...
    introspection_endpoint_auth_methods_supported: zod
      .array(zod.string())
      .optional(),
    revocation_endpoint: zod.string().optional(),
    revocation_endpoint_auth_methods_supported: zod
      .array(zod.string())
      .optional(),
