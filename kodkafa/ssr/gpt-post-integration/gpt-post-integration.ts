...
export const gptPostControllerCreateGptPost = async (createPostDto: CreatePostDto, options?: RequestInit): Promise<gptPostControllerCreateGptPostResponse> => {
  ...
  return ssrMutator<gptPostControllerCreateGptPostResponse>(getGptPostControllerCreateGptPostUrl(),
  {      
    ...options,
    method: 'POST',
...
export const gptPostControllerSearchPosts = async (params: GptPostControllerSearchPostsParams, options?: RequestInit): Promise<gptPostControllerSearchPostsResponse> => {
  ...
  return ssrMutator<gptPostControllerSearchPostsResponse>(getGptPostControllerSearchPostsUrl(params),
  {      
    ...options,
    method: 'GET'
...
export const gptPostControllerFindPostById = async (id: string, options?: RequestInit): Promise<gptPostControllerFindPostByIdResponse> => {
  ...
  return ssrMutator<gptPostControllerFindPostByIdResponse>(getGptPostControllerFindPostByIdUrl(id),
  {      
    ...options,
    method: 'GET'
...
export const gptPostControllerUpdateGptPost = async (id: string,
  ...
  return ssrMutator<gptPostControllerUpdateGptPostResponse>(getGptPostControllerUpdateGptPostUrl(id),
  {      
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const gptPostControllerUploadOpenAIFiles = async (id: string,
  ...
  return ssrMutator<gptPostControllerUploadOpenAIFilesResponse>(getGptPostControllerUploadOpenAIFilesUrl(id),
  {      
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const gptPostControllerUpdatePostFile = async (id: string,
  ...
  return ssrMutator<gptPostControllerUpdatePostFileResponse>(getGptPostControllerUpdatePostFileUrl(id,fileId),
  {      
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
