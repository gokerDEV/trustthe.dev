...
if(postsFileControllerUploadFileBody.exif !== undefined) {
 formData.append(`exif`, postsFileControllerUploadFileBody.exif)
  ...
  return ssrMutator<postsFileControllerUploadFileResponse>(getPostsFileControllerUploadFileUrl(post),
  {      
    ...options,
    method: 'POST'
    ,
...
export const postsFileControllerUpdateFile = async (post: string,
  ...
  return ssrMutator<postsFileControllerUpdateFileResponse>(getPostsFileControllerUpdateFileUrl(post,id),
  {      
    ...options,
    method: 'PATCH',
...
export const postsFileControllerDeleteFile = async (post: string,
  ...
  return ssrMutator<postsFileControllerDeleteFileResponse>(getPostsFileControllerDeleteFileUrl(post,id),
  {      
    ...options,
    method: 'DELETE'
